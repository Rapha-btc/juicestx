;; SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.zil-pre-faktory

;; 
          ;; fak.fun PRE @version 2.0
          ...
          ;; Token, Dex and sBTC
          (define-constant TOKEN-DAO 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.zil-faktory) ;; param
          (define-constant DEX-DAO 'SPV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RCJDC22.zil-faktory-dex) ;; param
          ...
          (define-public (refund (owner (optional principal)))
              (let ((seat-owner (default-to tx-sender owner))
                  ...
                  (asserts! (or 
                    ...
                    (match (contract-call? 'SP29D6YMDNAKN1P045T6Z817RTE1AC0JAA99WAX2B.agent-account-registry get-agent-account-info seat-owner)
       ...
       (define-read-only (get-max-seats-allowed)
        ...
        (define-read-only (get-seat-price)
            (ok PRICE-PER-SEAT)
        )
