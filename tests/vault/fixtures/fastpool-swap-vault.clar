...
;; One active batch: 288 burn blocks maker-first, then oracle-floored router
;; chunks <= 0.05 BTC, separated by >= 1 burn block. STX returns only to POOL.
;; Pool admin may set the window to zero between batches.
